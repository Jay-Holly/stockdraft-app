...
export function DayTraderTradingPanel({
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-xl border border-[var(--color-league-primary)]/30 bg-[var(--color-league-primary)]/5 p-4 space-y-3">
                ...
                <button
                  ...
                  className={`w-full rounded-lg border px-3 py-2 text-left text-sm transition-colors ${
                    selectedSymbol === result.symbol
                      ? "border-[var(--color-league-primary)] bg-[var(--color-league-primary)]/10"
                      : "border-dark-border bg-dark/60 hover:border-[var(--color-league-primary)]/40"
                  } disabled:opacity-50`}
                >
