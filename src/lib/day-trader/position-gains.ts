...
export type DayTraderPositionGainMetrics = Record<
  string,
  {
...
export function buildDayTraderPositionGainMetrics(
  ...args: unknown[]
): DayTraderPositionGainMetrics {
  throw notImplemented("buildDayTraderPositionGainMetrics");
}
