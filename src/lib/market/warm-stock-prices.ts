...
export function fetchWarmStockPrices(
  ...args: unknown[]
): { warm: Record<string, number>; cold: string[] } {
  return { warm: {}, cold: [] };
}

export function persistColdQuotesToStockPrices(...args: unknown[]) {
  throw notImplemented("persistColdQuotesToStockPrices");
}
