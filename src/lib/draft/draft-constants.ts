 ...
 * any of the 13 rounds, starter or bench), just hard caps on total stock
 * and total crypto a team can hold across the whole draft.
 */
export const SPORTS_SIM_SDFL_CRYPTO_CAP = 3;
export const SPORTS_SIM_SDFL_STOCK_CAP = 10;
