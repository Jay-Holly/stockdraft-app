...
export type ReleaseResult = {
  released: Array<{ totalReleased: number; [key: string]: unknown }>;
};

export function releaseFundsForDate(...args: unknown[]): ReleaseResult {
  throw notImplemented("releaseFundsForDate");
}
